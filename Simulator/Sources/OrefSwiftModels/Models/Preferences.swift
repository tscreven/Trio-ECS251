...
public enum CGMType: String, JSON, CaseIterable, Identifiable {
...
public enum GlucoseNotificationsOption: String, JSON, CaseIterable, Identifiable {
    case disabled
    case alwaysEveryCGM
...
public enum EstimatedA1cDisplayUnit: String, JSON, CaseIterable, Identifiable {
    public var id: String { rawValue }
    case percent
    case mmolMol
}

public enum GlucoseColorScheme: String, JSON, CaseIterable, Identifiable {
    public var id: String { rawValue }
    case staticColor
    case dynamicColor
}

public enum ForecastDisplayType: String, JSON, CaseIterable, Identifiable {
    public var id: String { rawValue }
    case cone
    case lines
}

public enum LockScreenView: String, JSON, CaseIterable, Identifiable {
    public var id: String { rawValue }
    case simple
    case detailed
}

public enum BolusShortcutLimit: String, JSON, CaseIterable, Identifiable {
    public var id: String { rawValue }
    case notAllowed
    case limitBolusMax
}

public enum TimeInRangeType: String, JSON, CaseIterable, Identifiable {
    public var id: String { rawValue }
    case timeInTightRange
    case timeInNormoglycemia
}

public struct Preferences: JSON, Equatable {
    ...
    public var advTargetAdjustments: Bool = false
    public var exerciseMode: Bool = false
    public var halfBasalExerciseTarget: Decimal = 160
    public var maxCOB: Decimal = 120
    public var maxMealAbsorptionTime: Decimal = 6
    public var wideBGTargetRange: Bool = false
    ...
    public var carbsReqThreshold: Decimal = 1.0
    ...
    public var useWeightedAverage: Bool = false
    public var weightPercentage: Decimal = 0.35
    public var tddAdjBasal: Bool = false
    public var enableSMB_high_bg: Bool = false
    public var enableSMB_high_bg_target: Decimal = 110
    public var threshold_setting: Decimal = 60
    public var updateInterval: Decimal = 20
