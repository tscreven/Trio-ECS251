...
public struct CarbImpactParams {
    public let cappedCarbImpact: Decimal
    public let carbImpactDuration: Decimal
    public let maxAbsorptionIntervals: Int
    public let triangleIntervals: Int
    public let remainingCarbImpactPeak: Decimal
    public let remainingCarbAbsorptionTime: Decimal
