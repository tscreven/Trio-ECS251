...
public enum TempBasalFunctionError: LocalizedError, Equatable {
...
public enum TempBasalFunctions {
    /// Rounds basal rates to match the basal increment for the pump as the basal rate increases
    public static func roundBasal(profile: Profile, basalRate: Decimal) -> Decimal {
    ...
    public static func getMaxSafeBasalRate(profile: Profile) throws -> Decimal {
