...
public struct MealCob {
    /// Internal structure to keep track of bucketed glucose values
    public struct BucketedGlucose: Codable {
        public let glucose: Decimal
        public let date: Date

        public func average(adding glucose: BucketedGlucose) -> BucketedGlucose {
    ...
    public struct CobResult {
        public let carbsAbsorbed: Decimal
        public let currentDeviation: Decimal
        public let maxDeviation: Decimal
        public let minDeviation: Decimal
        public let slopeFromMaxDeviation: Decimal
        public let slopeFromMinDeviation: Decimal
        public let allDeviations: [Decimal]
    }
    ...
    public static func detectCarbAbsorption(
    ...
    public static func bucketGlucoseForCob(
        glucose: [BloodGlucose],
        profile: Profile,
        mealDate: Date,
        carbImpactDate: Date?
